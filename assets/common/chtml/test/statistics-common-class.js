 ...
 */
var cjEchartsHistOptionClass = {
    createNewWithParams:function(){

    },
    createNew:function(){
        var obj = cjEchartsOptionBaseClass.createNew();
        ...
        obj.setSeries = function(type,data,map){
            if( data && data.length && data.length > 0 ) {
                ...
                for( var i = 0; i < obj.legend.data.length; i++ ){
                    var series = new Series(obj.legend.data[i],type,dataModel[obj.legend.data[i]]);
 ...
 */
var cjEchartsLineOptionClass = {
    createNew:function(){
        var obj = cjEchartsHistOptionClass.createNew();
    ...
    createNew:function(){
        ...
        obj.setSeries = function(type,data,map){
            if( data && data.length && data.length > 0 ) {
                ...
                for( var i = 0; i < obj.legend.data.length; i++ ){
                    var dataObj = new Data(obj.legend.data[i],dataModel[obj.legend.data[i]]);
                    dataArray.push(dataObj);
                }

                var series = new Series("",type,dataArray);
                obj.series.push(series);
            }
        }
 ...
 */
var cjEchartsDashBoardOptionClass = {
    createNew:function(){
        var obj = cjEchartsOptionBaseClass.createNew();
        ...
        obj.setSeries = function(type,data,name){
            ...
            if( data && data.length && data.length > 0 ) {
                var dividend = data[0].data;
                var value = (dividend/obj.totalCount).toFixed(2);
                var dataObj = new Data(name,value);

                var series = new Series(name,type,dataObj);
