		...
		init:function(){
			...
			$("#btnCustom").click(function(){
				$.custom({title:"自定义弹出框",html:"a<br/>b",width:500,height:200,buttons:[
					{text:"按钮1",callback:function(){alert("点击了按钮1。");this.close();}},
					{text:"按钮2",callback:function(){alert("点击了按钮2。");this.close();}},
					{text:"按钮3",callback:function(){alert("点击了按钮3。");this.close();}},
					{text:"按钮4",callback:function(){alert("点击了按钮4。");this.close();}}
				]});
			});
