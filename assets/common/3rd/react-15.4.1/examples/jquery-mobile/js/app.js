...
let JQueryMobileButton = React.createClass({
...
let JQueryMobileContent = React.createClass({
...
let JQueryMobileFooter = React.createClass({
...
let JQueryMobileHeader = React.createClass({
