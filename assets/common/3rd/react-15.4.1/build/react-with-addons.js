 ...
 */
        ...
        let ExecutionEnvironment = _dereq_(43);
 ...
 */
        ...
        let ReactLink = _dereq_(20);
        let ReactStateSetters = _dereq_(26);
 ...
 */
        ...
        let _prodInvariant = _dereq_(38);

        let invariant = _dereq_(46);
 ...
 */
        ...
        let _assign = _dereq_(49);

        let ReactChildren = _dereq_(9);
        let ReactComponent = _dereq_(11);
        let ReactPureComponent = _dereq_(25);
        let ReactClass = _dereq_(10);
        let ReactDOMFactories = _dereq_(15);
        let ReactElement = _dereq_(16);
        let ReactPropTypes = _dereq_(23);
        let ReactVersion = _dereq_(30);

        let onlyChild = _dereq_(37);
        let warning = _dereq_(48);
        ...
        if ('development' !== 'production') {
            let ReactElementValidator = _dereq_(18);
 ...
 */
        ...
        let ReactTransitionGroup = _dereq_(29);
        let ReactCSSTransitionGroupChild = _dereq_(8);
 ...
 */
        ...
        let ReactCSSTransitionGroup = function(_React$Component) {
        ...
        function ReactCSSTransitionGroup() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call(...[this].concat(args))), _this), _this._wrapChild = function(child) {
 ...
 */
    ...
    let React = _dereq_(5);
    let ReactAddonsDOMDependencies = _dereq_(6);

    let CSSCore = _dereq_(42);
    let ReactTransitionEvents = _dereq_(28);

    let onlyChild = _dereq_(37);

    let TICK = 17;

    let ReactCSSTransitionGroupChild = React.createClass({
    ...
    // or a bool for the timeout flags (appearTimeout etc.)
        ...
        transition: function(animationType, finishCallback, userSpecifiedDelay) {
            let node = ReactAddonsDOMDependencies.getReactDOM().findDOMNode(this);
 ...
 */
    ...
    let PooledClass = _dereq_(4);
    let ReactElement = _dereq_(16);

    let emptyFunction = _dereq_(44);
    let traverseAllChildren = _dereq_(40);
 ...
 */
    ...
    let ReactComponent = _dereq_(11);
    let ReactElement = _dereq_(16);
    let ReactPropTypeLocationNames = _dereq_(22);
    let ReactNoopUpdateQueue = _dereq_(21);

    let emptyObject = _dereq_(45);
    let invariant = _dereq_(46);
    let warning = _dereq_(48);
 ...
 */
  ...
  // mixins are listed before or after these methods in the spec.
      ...
      // 2. Overridden methods (that were mixed in).
                ...
                let shouldAutoBind = isFunction && !isReactClassMethod && !isAlreadyDefined && spec.autobind !== false;
 ...
 */
    ...
    let canDefineProperty = _dereq_(33);
    let emptyObject = _dereq_(45);
    let invariant = _dereq_(46);
    let warning = _dereq_(48);
 ...
 */
    ...
    let ReactCurrentOwner = _dereq_(14);
 ...
 */
    ...
    let REACT_ELEMENT_TYPE = _dereq_(17);
 ...
 */
    ...
    let ReactCurrentOwner = _dereq_(14);
    let ReactComponentTreeHook = _dereq_(12);
    let ReactElement = _dereq_(16);

    let checkReactTypeSpec = _dereq_(34);

    let canDefineProperty = _dereq_(33);
    let getIteratorFn = _dereq_(36);
    let warning = _dereq_(48);
 ...
 */
    ...
    let ReactElement = _dereq_(16);
    let ReactPropTypeLocationNames = _dereq_(22);
    let ReactPropTypesSecret = _dereq_(24);
 ...
 */
   ...
   */
        createStateSetter: function(component, funcReturningState) {
            return function(a, b, c, d, e, f) {
                let partialState = funcReturningState.call(component, a, b, c, d, e, f);
                if (partialState) {
   ...
   */
    ...
    // Memoize the setters.
            let cache = component.__keySetters || (component.__keySetters = {});
 ...
 */
    ...
    let flattenChildren = _dereq_(35);
 ...
 */
    ...
    let getVendorPrefixedEventName = _dereq_(1);

    let endEvents = [];

    function detectEvents() {
        let animEnd = getVendorPrefixedEventName('animationend');
        let transEnd = getVendorPrefixedEventName('transitionend');
 ...
 */
    ...
    let React = _dereq_(5);
    let ReactAddonsDOMDependencies = _dereq_(6);
    let ReactTransitionChildMapping = _dereq_(27);
 ...
 */
    ...
    let ReactTransitionGroup = function(_React$Component) {
      ...
      // TODO: can we get useful debug information to show at this point?
        ...
        // This entered again before it fully left. Add it again.
                ...
                _this.setState(function(state) {
                  let newChildren = _assign({}, state.children);
 ...
 */
    ...
    let LinkedStateMixin = _dereq_(3);
    let React = _dereq_(5);
    let ReactAddonsDOMDependencies = _dereq_(6);
    let ReactComponentWithPureRenderMixin = _dereq_(13);
    let ReactCSSTransitionGroup = _dereq_(7);
    let ReactFragment = _dereq_(19);
    let ReactTransitionGroup = _dereq_(29);

    let shallowCompare = _dereq_(39);
    let update = _dereq_(41);
 ...
 */
    ...
    let ReactWithAddons = _dereq_(31);

// `version` will be added here by the React module.
    let ReactWithAddonsUMDEntry = _assign({
...
/* global hasOwnProperty:true */
    ...
    let COMMAND_PUSH = '$push';
    let COMMAND_UNSHIFT = '$unshift';
    let COMMAND_SPLICE = '$splice';
    let COMMAND_SET = '$set';
    let COMMAND_MERGE = '$merge';
    let COMMAND_APPLY = '$apply';
...
/* Slow implementation for browsers that don't natively support .matches() */
   ...
   */
        matchesSelector: function matchesSelector(element, selector) {
            let matchesImpl = element.matches || element.webkitMatchesSelector || element.mozMatchesSelector || element.msMatchesSelector || function(s) {
