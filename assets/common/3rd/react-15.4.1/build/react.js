 ...
 */
        ...
        let _prodInvariant = _dereq_(24);

        let invariant = _dereq_(28);
 ...
 */
        ...
        let _assign = _dereq_(30);

        let ReactChildren = _dereq_(4);
        let ReactComponent = _dereq_(6);
        let ReactPureComponent = _dereq_(17);
        let ReactClass = _dereq_(5);
        let ReactDOMFactories = _dereq_(9);
        let ReactElement = _dereq_(10);
        let ReactPropTypes = _dereq_(15);
        let ReactVersion = _dereq_(19);

        let onlyChild = _dereq_(23);
        let warning = _dereq_(29);
        ...
        if ('development' !== 'production') {
            let ReactElementValidator = _dereq_(12);
 ...
 */
        ...
        let emptyFunction = _dereq_(26);
        let traverseAllChildren = _dereq_(25);
 ...
 */
        ...
        let ReactComponent = _dereq_(6);
        let ReactElement = _dereq_(10);
        let ReactPropTypeLocationNames = _dereq_(14);
        let ReactNoopUpdateQueue = _dereq_(13);

        let emptyObject = _dereq_(27);
        let invariant = _dereq_(28);
        let warning = _dereq_(29);
 ...
 */
        ...
        let canDefineProperty = _dereq_(20);
        let emptyObject = _dereq_(27);
        let invariant = _dereq_(28);
        let warning = _dereq_(29);
 ...
 */
        ...
        let ReactCurrentOwner = _dereq_(8);
 ...
 */
    ...
    let REACT_ELEMENT_TYPE = _dereq_(11);
 ...
 */
    ...
    let ReactCurrentOwner = _dereq_(8);
    let ReactComponentTreeHook = _dereq_(7);
    let ReactElement = _dereq_(10);

    let checkReactTypeSpec = _dereq_(21);

    let canDefineProperty = _dereq_(20);
    let getIteratorFn = _dereq_(22);
    let warning = _dereq_(29);
 ...
 */
    ...
    let ReactElement = _dereq_(10);
    let ReactPropTypeLocationNames = _dereq_(14);
    let ReactPropTypesSecret = _dereq_(16);
