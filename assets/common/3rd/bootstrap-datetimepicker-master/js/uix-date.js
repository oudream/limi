define(['jquery', 'util', 'bootstrap', 'bootstrap-dateCN'], function($, util) {
	...
	$.fn.extend({
		"uixDate": function(params,val) {
			...
			//end获取参数
			var template = '<div class="input-append date ' + type + '" data-date-format="' + format + '"  data-date ="' + value + '" data-link-field="' + $(this).attr("id") + '"><input size="16" name=" ' + name + '" type="text" value="' + value + '" ' + readonly + '>';
			//			if(!hideRemove) {
