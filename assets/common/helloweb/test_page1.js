(function(global, factory) {
    ...
    let SlsPage = function SlsPage(opts) {
        let this$1 = this;
   ...
   */
    ...
    // 此行代码，可以得出当前页码个数是否等于需要显示的个数
        let curPageNum = this.params.page_end - this.params.page_start + 1;
    // 设置左右偏移
    ...
    // 组装需要显示的页码
        ...
        for (let i = this.params.page_start; i <= this.params.page_end; i++) {
            let tempObj = {
                page: i,
            };
